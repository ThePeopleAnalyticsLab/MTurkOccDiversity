...
BLS <- 
BLS[c(2,71,129,162,222,293,320,336,432,494,586,612,653,687,705,767,810,923,950,1054,1130,1298,1395,1),]
=======
...
>>>>>>> a6d296fae9ad40beeb0a5bc9dd34bee8c90eea83
...
##LATech data
LATech <- read_csv("Chris's Data from 2015.csv")
=======
#Only keep occupational categories (no all).
BLS <- BLS[-14,]
...
##UGA data
<<<<<<< HEAD
UGA <- read_excel("Rachel's Data from 2015.xlsx")
=======
...
BLS_edu <- sapply(BLS_education, prop_func)
