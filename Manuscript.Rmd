...
```{r Barplot, echo = FALSE, warning = FALSE, fig.cap = "Comparing the occupational diversity of two MTurk samples with expecations based on the Bureau of Labor Statistics"}
...
# Get dems
MTurk15 <- read_csv("Demographics.csv")
